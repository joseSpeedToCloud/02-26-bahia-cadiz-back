...
Deriva de [`especificaciones/SPEC-001-plataforma-bahia-cadiz.md`](../especificaciones/SPEC-001-plataforma-bahia-cadiz.md). Cubre solo la parte de **backend**: infraestructura cloud y núcleo del CMS. Total: 27 tasks, 91 story points.
...
## CMS (Drupal headless) — 75 SP *(story points estimados; el checklist original no detallaba esta categoría en esta sesión)*
